...
--               Organization/Projects/Lab06/CPU_plus/CPU_plus.srcs/sources_1/ip/DataMem/DataMem_sim_netlist.vhdl}
-- Design      : DataMem
...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000000000D2"
    )
        port map (
...
ram_reg_0_127_1_1: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000000009D0"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(1),
...
ram_reg_0_127_2_2: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000000006DE"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(2),
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000000000000000000000000000A9D"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(3),
...
ram_reg_0_127_5_5: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000000007BE"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(5),
...
ram_reg_0_127_6_6: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000000007DF"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(6),
